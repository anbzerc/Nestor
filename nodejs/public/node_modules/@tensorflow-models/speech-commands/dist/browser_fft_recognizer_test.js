        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 8:
                    ...
                    maxWeightChanges = newTransferWeightValues.map(function (newValues, i) { return tf.max(tf.abs(tf.sub(tf.tensor1d(newValues), tf.tensor1d(oldTransferWeightValues[i])))).dataSync()[0]; });
